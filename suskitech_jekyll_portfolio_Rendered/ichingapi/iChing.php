...
class iChing {
	...
	public static function interpretUpperTrigram($hexVal){
		$uppertest = substr($hexVal, 3);
		$upperTrigram = "";
		if ($uppertest == "000")
			$upperTrigram = "Earth";
		if ($uppertest == "001")
	...
	public static function interpretLowerTrigram($hexVal){
		$lowertest = substr($hexVal, 0, 3);
		$lowerTrigram = "";
		if ($lowertest == "000")
			$lowerTrigram = "Earth";
		if ($lowertest == "001")
	...
	public static function interpretNumber ($hexvalue) {
		if ($hexvalue == "111111")
			return "1";
		if ($hexvalue == "000000")
			return "2";
	...
	public static function interpretHexagram ($hexvalue) {
		if ($hexvalue == "111111")
			return "The Creative";
		if ($hexvalue == "000000")
			return "The Receptive";
		if ($hexvalue == "100010")
			return "Difficulty at the Beginning";
		if ($hexvalue == "010001")
			return "Youthful Folly";
		if ($hexvalue == "111010")
			return "Waiting (Nourishment)";
		if ($hexvalue == "010111")
			return "Conflict";
		if ($hexvalue == "010000")
			return "The Army";
		if ($hexvalue == "000010")
			return "Holding Together [union]";
		if ($hexvalue == "111011")
			return "The Taming Power of the Small";
		if ($hexvalue == "110111")
			return "Treading [conduct]";
		if ($hexvalue == "111000")
			return "Peace";
		if ($hexvalue == "000111")
			return "Standstill [Stagnation]";
		if ($hexvalue == "101111")
			return "Fellowship with Men";
		if ($hexvalue == "111101")
		...
		if ($hexvalue == "100110")
			return "Following";
		if ($hexvalue == "011001")
			return "Work on what has been spoiled [ Decay ]";
		if ($hexvalue == "110000")
			return "Approach";
		if ($hexvalue == "000011")
			return "Contemplation (View)";
		if ($hexvalue == "100101")
			return "Biting Through";
		if ($hexvalue == "101001")
			return "Grace";
		if ($hexvalue == "000001")
			return "Splitting Apart";
		if ($hexvalue == "100000")
			return "Return (The Turning Point)";
		if ($hexvalue == "100111")
			return "Innocence (The Unexpected)";
		if ($hexvalue == "111001")
			return "The Taming Power of the Great";
		if ($hexvalue == "100001")
			return "Corners of the Mouth (Providing Nourishment)";
		if ($hexvalue == "011110")
			return "Preponderance of the Great";
		if ($hexvalue == "010010")
			return "The Abysmal (Water)";
		if ($hexvalue == "101101")
			return "The Clinging, Fire";
		if ($hexvalue == "001110")
			return "Influence (Wooing)";
		if ($hexvalue == "011100")
			return "Duration";
		if ($hexvalue == "001111")
			return "Retreat";
		if ($hexvalue == "111100")
			return "The Power of the Great";
		if ($hexvalue == "000101")
			return "Progress";
		if ($hexvalue == "101000")
			return "Darkening of the light";
		if ($hexvalue == "101011")
			return "The Family [The Clan]";
		if ($hexvalue == "110101")
			return "Opposition";
		if ($hexvalue == "001010")
			return "Obstruction";
		...
		if ($hexvalue == "100011")
			return "Increase";
		if ($hexvalue == "111110")
			return "Break-through (Resoluteness)";
		if ($hexvalue == "011111")
			return "Coming to Meet";
		if ($hexvalue == "000110")
			return "Gathering Together [Massing]";
		if ($hexvalue == "011000")
			return "Pushing Upward";
		if ($hexvalue == "010110")
			return "Oppression (Exhaustion)";
		if ($hexvalue == "011010")
			return "The Well";
		if ($hexvalue == "101110")
			return "Revolution (Molting)";
		if ($hexvalue == "011101")
			return "The Caldron";
		if ($hexvalue == "100100")
			return "The Arousing (Shock, Thunder)";
		if ($hexvalue == "001001")
			return "Keeping Still, Mountain";
		if ($hexvalue == "001011")
			return "Development (Gradual Progress)";
		if ($hexvalue == "110100")
			return "The Marrying Maiden";
		if ($hexvalue == "101100")
			return "Abundance [Fullness]";
		if ($hexvalue == "001101")
			return "The Wanderer";
		if ($hexvalue == "011011")
			return "The Gentle (The Penetrating, Wind)";
		if ($hexvalue == "110110")
			return "The Joyous, Lake";
		if ($hexvalue == "010011")
			return "Dispersion [Dissolution]";
		if ($hexvalue == "110010")
			return "Limitation";
		if ($hexvalue == "110011")
			return "Inner Truth";
		if ($hexvalue == "001100")
			return "Preponderance of the Small";
		if ($hexvalue == "101010")
	...
	public static function interpretChineseTitle ($hexvalue) {
		if ($hexvalue == "111111")
			return "Ch'ien";
		if ($hexvalue == "000000")
			return "K'un";
	...
	public static function interpretUnicode ($hexvalue) {
		if ($hexvalue == "111111")
			return "䷀";
		if ($hexvalue == "000000")
			return "䷁";
	...
	public static function interpretJudgement($hexvalue){
		if ($hexvalue == "111111")
	...
	public static function interpretImage($hexvalue){
		if ($hexvalue == "111111")
	...
	public static function interpretLines ($hexvalue, $linesAge) {
		if ($hexvalue == "111111"){
			$linesReturn = "";
			if ($linesAge[0] == "1")
